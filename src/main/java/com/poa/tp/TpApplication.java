...
public class TpApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Turno t1 = new Turno(null,null,30, TipoPatologia.INFECCION_OIDO, p1 );
		Turno t2 = new Turno(null,null,45, TipoPatologia.INFECCION_URINARIA , p1);
		Turno t3 = new Turno(null,null,40,TipoPatologia.SINUSITIS , p2);
